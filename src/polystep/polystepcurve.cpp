...
{
  m_point = QPointF(
      toInch(getDoubleAttribute(xml, "PolyStepCurve", "x"), units),
      toInch(getDoubleAttribute(xml, "PolyStepCurve", "y"), units));
  m_centerPoint = QPointF(
      toInch(getDoubleAttribute(xml, "PolyStepCurve", "centerX"), units),
      toInch(getDoubleAttribute(xml, "PolyStepCurve", "centerY"), units));
