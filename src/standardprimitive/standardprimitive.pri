HEADERS += \
  ...
  standardprimitive/rectround.h \
  standardprimitive/thermal.h \
  standardprimitive/triangle.h \
  standardprimitive/standardprimitive.h

SOURCES += \
  standardprimitive/butterfly.cpp \
  standardprimitive/circle.cpp \
  standardprimitive/contour.cpp \
  standardprimitive/diamond.cpp \
  standardprimitive/donut.cpp \
  standardprimitive/ellipse.cpp \
  standardprimitive/hexagon.cpp \
  ...
  standardprimitive/rectround.cpp \
  standardprimitive/thermal.cpp \
  standardprimitive/triangle.cpp
